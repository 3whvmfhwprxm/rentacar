...
public class CompanyVO {
	...
	public String toString() {
		return "CompanyVO [comId=" + comId + ", comName=" + comName + ", comPwd=" + comPwd + ", comNum=" + comNum
				+ ", comTel1=" + comTel1 + ", comTel2=" + comTel2 + ", comTel3=" + comTel3 + ", comMobile1="
				+ comMobile1 + ", comMobile2=" + comMobile2 + ", comMobile3=" + comMobile3 + ", comFax1=" + comFax1
				+ ", comFax2=" + comFax2 + ", comFax3=" + comFax3 + ", comAddress=" + comAddress + ", comCeo=" + comCeo
				+ ", comEmail1=" + comEmail1 + ", comEmail2=" + comEmail2 + ", comLogo=" + comLogo + ", comRegdate="
				+ comRegdate + ", comOutdate=" + comOutdate + "]";
	}
