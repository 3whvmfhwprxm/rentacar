...
<script type="text/javascript">
	...
	function jusoCallBack(addrDetail) {
		document.frm1.comAddress.value = addrDetail;
	}
...
<div class="bodyClass">
	<form class="form-horizontal" id="frm1" name="frm1" method="post"
		...
		<div class="form-group">
			<label for="CompanyPwd" class="col-sm-2 control-label"> 비밀번호
			</label>
			<div class="col-sm-8">
		...
		<div class="form-group">
			<label for="CompanyPwd2" class="col-sm-2 control-label"> 비밀번호
				확인 </label>
			<div class="col-sm-8">
		...
		<div class="form-group">
			<label for="CompanyEmail" class="col-sm-2 control-label"> 이메일</label>
			<div class="col-md-8">
		...
		<div class="form-group">
			<label for="CompanyRate" class="col-sm-2 control-label"> 수수료</label>
			<div class="col-md-8">
		...
		<div class=form-group>
			...
			<div class="col-sm-8">
				<button type="submit" class="btn btn-primary btn-lg btn-block"
					id="btCompanyRegister">업체 등록</button>
			</div>
		</div>
	</form>
</div>
