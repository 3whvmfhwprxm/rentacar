...
<div class="bodyClass">
	<div class="w3-container">
		<div class="row">
			<div class="col-md-12">
				<h1 style="text-align: center;">${param.comId}보유차량</h1>
			</div>
		</div>
				...
				<div class="col-sm-6">
					<div
						...
						<div class="media" style="height: 250px;">
							<a class="pull-left"
								href='<c:url value="/administrator/carModel/modelDetail.do?carCode=${map['CAR_CODE']}" />'
								target="_parent"> <img style="width: 300px; height: 250px;"
							...
							<div class="media-body fnt-smaller">
								...
								<p class="hidden-xs">
									<span style="font-size: 1.2em; font-weight: bold;">※예약
										가격</span><br>
							...
							극성수기: <fmt:formatNumber value="${map['CCAR_S_PEAK_PRICE']}"
								...
								<span> 차량 등록일: <fmt:formatDate
										value="${map['COMCAR_REGDATE']}" pattern="yyyy-MM-dd" /><br>
								</span> <span style="color: red"> <c:if
										test="${!empty map['COMCAR_OUTDATE']}">
