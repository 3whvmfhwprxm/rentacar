...
CREATE TABLE Company (
	...
	com_regdate DATE default sysdate NOT NULL, /* 가입일 */
...
CREATE TABLE Reservation (
	...
	reserv_date DATE default sysdate NOT NULL, /* 예약일시 */
...
CREATE TABLE Counsel (
	...
	counsel_regdate DATE default sysdate NOT NULL, /* 상담시간 */
...
CREATE TABLE comments (
	...
	cmt_regdate DATE default sysdate NOT NULL, /* 기록일 */
...
CREATE TABLE PayInfo (
	...
	pay_regdate DATE default sysdate NOT NULL, /* 결제일시 */
...
CREATE TABLE Event (
	...
	admin_id VARCHAR2(30) NOT NULL, /* 관리자아이디 */
	event_regdate DATE default sysdate NOT NULL, /* 작성시간 */
...
CREATE TABLE CompanyCarOption (
	...
	comcar_regdate DATE default sysdate NOT NULL, /* 차량등록일 */
...
CREATE TABLE rent_admin (
	...
	admin_regdate DATE default sysdate NOT NULL, /* 등록일 */
...
CREATE TABLE Member_grade (
	...
	mem_gra_regdate DATE default sysdate NOT NULL, /* 등급결정일 */
