...
values('T3000016', '010','4600','2630', to_date('2017-03-03 11:00','yyyy/mm/dd hh24:mi'), 
to_date('2017-03-04 18:30','yyyy/mm/dd hh24:mi'), '01허1234', '자차보험', '2017-03-01' ,'kim1');

insert into PAYINFO(pay_no, reserv_num, user_tel1, user_tel2, 
user_tel3, pay_method, pay_money, pay_condition, pay_regdate)
values('p001000', 'T3000016', '010', '4600', '2630', 'card', 49000, 'paid', '2017-03-01');

insert into reserv_user
values('T3000016', '김엄마', '010', '5341', '2322', 'kim2@naver.com', '김아빠', '011', '1112', '1112', '801103', '2종보통');
--
insert into RESERVATION(
reserv_num, user_tel1, user_tel2, user_tel3, reserv_start_date, reserv_end_date,
ccar_car_id, reserv_insurance, reserv_date, user_id)
