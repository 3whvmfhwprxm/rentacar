...
DROP TABLE CAR_CATEGORY CASCADE CONSTRAINTS;
DROP TABLE COMPANY CASCADE CONSTRAINTS;
DROP TABLE RENT_USER CASCADE CONSTRAINTS;
DROP TABLE RESERVATION CASCADE CONSTRAINTS;
DROP TABLE USERNOTICE CASCADE CONSTRAINTS;
DROP TABLE SERVICECENTERNOTICE CASCADE CONSTRAINTS;
DROP TABLE COMPANYNOTICE CASCADE CONSTRAINTS;
DROP TABLE COUNSEL CASCADE CONSTRAINTS;
DROP TABLE COMMENTS CASCADE CONSTRAINTS;
DROP TABLE PAYINFO CASCADE CONSTRAINTS;
DROP TABLE EVENT CASCADE CONSTRAINTS;
DROP TABLE COMPANYCAROPTION CASCADE CONSTRAINTS;
DROP TABLE RENT_ADMIN CASCADE CONSTRAINTS;
...
CREATE TABLE Company (
	...
	com_address VARCHAR2(200) NOT NULL, /* 회사주소 */
	com_return_place VARCHAR2(200) NOT NULL, /* 차량 인수, 반납장소 17.04.29 추가됨 */
...
CREATE TABLE CompanyCarOption (
	...
	ccar_status VARCHAR2(25) default 'HOLD', /* 차량 차고지에 유무(차고지에 있으며 예약잡힌 상태:HOLD, 나간상태:RENT, 예약이 끝나고 차고지로:RETURN  */
...
CREATE TABLE rent_admin (
	...
	admin_email VARCHAR2(50) NOT NULL, /* 이메일 */
...
CREATE TABLE Reserv_User (
	...
	res_u_mail VARCHAR2(50) NOT NULL, /* 예약자이메일 */
