...
CREATE TABLE Reservation (
	...
	reserv_cancel_why VARCHAR2(1000), /* 예약취소사유 */
...
CREATE TABLE UserNotice (
	...
	unotice_regdate DATE NOT NULL, /* 작성시간 */
	unotice_visible CHAR(6) NOT NULL, /* 글노출 */
	unotice_readcount NUMBER NOT NULL, /* 조회수 */
...
CREATE TABLE ServiceCenterNotice (
	...
	admin_id VARCHAR2(30) NOT NULL, /* 관리자아이디 */
	scnotice_regdate DATE NOT NULL, /* 작성시간 */
	scnotice_visible CHAR(6) NOT NULL, /* 글노출 */
	scnotice_readcount NUMBER NOT NULL, /* 조회수 */
...
CREATE TABLE CompanyNotice (
	...
	admin_id VARCHAR2(30) NOT NULL, /* 관리자아이디 */
	cnotice_regdate DATE NOT NULL, /* 작성시간 */
	cnotice_visible CHAR(6) NOT NULL, /* 글노출 */
	cnotice_readcount NUMBER NOT NULL, /* 조회수 */
...
CREATE TABLE Counsel (
	...
	counsel_result CLOB NOT NULL, /* 처리내용 */    --데이터 타입을  varchar2→CLob로 변경
	counsel_result_flag VARCHAR2(10) NOT NULL, /* 처리결과 */ --데이터 타입을  varchar2(200)→varchar2(10)변경
	admin_id VARCHAR2(30) NOT NULL /* 관리자아이디 */
);
...
CREATE TABLE PayInfo (
	...
	pay_regdate DATE NOT NULL, /* 결제일시 */
...
CREATE TABLE Event (
	...
	event_title VARCHAR2(200) NOT NULL, /* 이벤트제목 */
	event_content VARCHAR2(200) NOT NULL, /* 이벤트내용 */
	admin_id VARCHAR2(30) NOT NULL, /* 관리자아이디 */
	event_regdate DATE NOT NULL, /* 작성시간 */
	event_start_date DATE NOT NULL, /* 이벤트시작일 */
	event_end_date DATE NOT NULL, /* 종료일 */
...
CREATE TABLE CompanyCarOption (
	...
	car_code VARCHAR2(100) NOT NULL, /* 모델코드 */
	com_id VARCHAR2(30) NOT NULL, /* 업체아이디 */
	ccar_use_yn CHAR(6) NOT NULL, /* 차량사용가능여부 */
	ccar_blackbox_yn CHAR(6) NOT NULL, /* 블랙박스유무 */
	ccar_smoke_yn CHAR(6) NOT NULL, /* 금연차량 */
	ccar_rear_camera_yn CHAR(6) NOT NULL, /* 후방카메라 */
	ccar_rear_sence_yn CHAR(6) NOT NULL, /* 후방센서 */
	ccar_navi_yn CHAR(6) NOT NULL, /* 네비게이션 */
	ccar_sun_roof_yn CHAR(6) NOT NULL, /* 썬루프 */
	ccar_bluetooth_yn CHAR(6) NOT NULL, /* 블루투스 */
	ccar_aux_yn CHAR(6) NOT NULL, /* AUX */
	ccar_smartkey_yn CHAR(6) NOT NULL, /* 스마트키 */
	ccar_rentalcount NUMBER NOT NULL, /* 차량대여횟수 */
	...
	comcar_regdate DATE NOT NULL, /* 차량등록일 */
...
CREATE TABLE rent_admin (
	...
	admin_regdate DATE NOT NULL, /* 등록일 */
...
CREATE TABLE Member_grade (
	...
	mem_gra_regdate DATE NOT NULL, /* 등급결정일 */
